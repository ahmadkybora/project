                    ...
                    <form class="card-body">
                        @if((isset($skillList->id)))
                            <form method="POST" enctype="multipart/form-data"
                                  action="{{ url("admin/update/skillList",$skillList->id) }}">
                                @else
                                    <form method="POST" enctype="multipart/form-data"
                                          action="{{ url("admin/add/skillList") }}">
                                        @endif
                                        @csrf
                                        @if(!isset($skillList->id))
                                            <input type="hidden" name="id" value="0">
                                        @else
                                            <input type="hidden" name="id" value="{{$skillList->id}}">
                                        @endif
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3 paddingtop15px">
                                                    <input type="text" class="form-control" name="name"
                                                           ...
                                                           placeholder="نام" required="" value="
                                                           @if(isset($skillList->id))
                                                    {{ $skillList->name }}
                                                    @endif
                                                        "/>
